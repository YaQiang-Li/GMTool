...
public:
	...
	void Notify(TNotifyUI& msg)
	{
		...
		else if (msg.sType == _T("selectchanged"))
		{
			...
			else if (name == _T("cb_reward"))
				pControl->SelectItem(3);
			else if (name == _T("cwar_hero_reward"))
				pControl->SelectItem(4);
			else if (name == _T("cwar_group_reward"))
				pControl->SelectItem(5);
			else if (name == _T("pitch_reward"))
				pControl->SelectItem(6);
			else if (name == _T("tools"))
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
	...
	CPaintManagerUI::SetResourcePath(CPaintManagerUI::GetInstancePath() + _T("skin\\GMToolRes"));
